...
export const Card = ({ taskObj, index, deleteTask, updateListArray }) => {
    ...
    return (
        <div className="custom-card">
            ...
            <div className="custom-card-header" style={{ backgroundColor: colors[index % 5].primaryColor }}>{taskObj.dueDate}</div>
            <div className="custom-card-header" style={{ backgroundColor: colors[index % 5].primaryColor }}>{taskObj.status}</div>
